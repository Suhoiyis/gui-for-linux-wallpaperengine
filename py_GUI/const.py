...
.stop-btn {
    background: alpha(@destructive_color, 0.15);
...
.stop-btn:hover {
    background: alpha(@destructive_color, 0.25);
    color: mix(@destructive_color, white, 0.1);
}
...
.wallpaper-card:hover {
    ...
    box-shadow: 0 8px 20px alpha(black, 0.25);
}
...
.wallpaper-item:hover {
    ...
    box-shadow: 0 0 15px alpha(@accent_bg_color, 0.3);
}
...
.list-type {
    color: mix(@accent_color, @theme_fg_color, 0.8);
    font-size: 0.85em;
}

.list-tags {
    color: mix(purple, @theme_fg_color, 0.7);
    font-size: 0.85em;
}
...
.list-folder {
    color: mix(green, @theme_fg_color, 0.6);
    font-size: 0.85em;
}
...
.sidebar {
    ...
    margin: 20px;
    margin-left: 0;
    box-shadow: -5px 0 15px alpha(black, 0.1);
    min-width: 320px;
    max-width: 320px;
    width: 320px;
}
...
.sidebar-btn:hover {
    background: mix(@accent_bg_color, white, 0.1);
}
